...
function allArmenian(){
    ...
    .then((data) => {
      for (let key in data["everyday_tours"]["armenian"]) {
        document.querySelector(`${key}`).innerHTML = data["everyday_tours"]["armenian"][key];
      }
    });
}
function allRussian(){
    ...
    .then((data) => {
      for (let key in data["everyday_tours"]["russian"]) {
        document.querySelector(`${key}`).innerHTML = data["everyday_tours"]["russian"][key];
      }
    });
}
function allEnglish(){
    ...
    .then((data) => {
      for (let key in data["everyday_tours"]["english"]) {
        document.querySelector(`${key}`).innerHTML = data["everyday_tours"]["english"][key];
      }
    });
}
...
function allUSD(){
    ...
    .then((data) => {
      for (let key in data["everyday_tours"]["USD"]) {
        document.querySelector(`${key}`).innerHTML = data["everyday_tours"]["USD"][key];
      }
    });
}
function allRUB(){
    ...
    .then((data) => {
      for (let key in data["everyday_tours"]["RUB"]) {
        document.querySelector(`${key}`).innerHTML = data["everyday_tours"]["RUB"][key];
      }
    });
}
function allAMD(){
    ...
    .then((data) => {
      for (let key in data["everyday_tours"]["AMD"]) {
        document.querySelector(`${key}`).innerHTML = data["everyday_tours"]["AMD"][key];
      }
    });
}